...
def main():
    'main関数'
    print("If (num1 + num2) is an even number, do Tetris!!!!")
    print("If it's not, arithmetic operations are shown!")

    num1 = float(input("first num is : "))
    num2 = float(input("second num is : "))
